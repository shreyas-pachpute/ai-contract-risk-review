"""Central configuration. PROJECT.md Section 8: policy comparison is a
fixed rules-engine problem -- the playbook thresholds are named constants
here, not buried in prompts or left to the model's judgment.
"""
